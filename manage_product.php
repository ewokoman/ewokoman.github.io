            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="product_code" class="control-label">Код</label>
                    ...
                    <div class="form-group">
                        ...
                        <select name="category_id" id="category_id" class="form-select form-select-sm rounded-0 select2" required>
                            <option <?php echo (!isset($category_id)) ? 'selected' : '' ?> disabled>Пожалуйста, выберите здесь</option>
                            <?php
                    ...
                    <div class="form-group">
                        <label for="alert_restock" class="control-label">Алерт на кол-во для пополнения</label>
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <select name="status" id="status" class="form-select form-select-sm rounded-0" required>
                            <option value="1" <?php echo isset($status) && $status == 1 ? 'selected' : '' ?>>Активно</option>
                            <option value="0" <?php echo isset($status) && $status == 0 ? 'selected' : '' ?>>Не активно</option>
                        </select>
                    </div>
                </div>
            </div>
