                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <select name="product_id" id="product_id" class="form-select form-select-sm rounded-0 select2" required >
                            <option <?php echo (!isset($product_id)) ? 'selected' : '' ?> disabled>Пожалуйста, выберите здесь</option>
                            <?php
                    ...
                    <div class="form-group">
                        <label for="expiry_date" class="control-label">Дата истечения срока</label>
