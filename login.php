...
<head>
    ...
    <title>ВХОД | Система управления пекарней</title>
...
<body class="">
   <div class="h-100 d-flex jsutify-content-center align-items-center">
       <div class='w-100'>
        <h1 class="py-5 text-center text-light px-4" id="sys_title">Система управления пекарней</h1>
        <div class="card my-3 col-md-4 offset-md-4">
            <div class="card-body">
                <form action="" id="login-form">
                    <center><small>Пожалуйста, введите свои учетные данные.</small></center>
                    ...
                    <div class="form-group d-flex w-100 justify-content-end">
                        <button class="btn btn-sm btn-primary rounded-0 my-1">Логин</button>
                    </div>
                </form>
            </div>
        </div>
