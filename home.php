<div class="content py-3">
    <div class="card rounded-0 shadow">
        <div class="card-body">
            <h3>Добро пожаловать в систему управления пекарней</h3>
            <hr>
            <div class="col-12">
                            ...
                            <div class="card-body">
                                <div class="w-100 d-flex align-items-center">
                                    ...
                                    <div class="col-auto flex-grow-1">
                                        <div class="fs-5"><b>Категории</b></div>
                        ...
                        <div class="card text-dark">
                            <div class="card-body">
                                <div class="w-100 d-flex align-items-center">
                                    ...
                                    <div class="col-auto flex-grow-1">
                                        <div class="fs-5"><b>Продаж сегодня</b></div>
                                        <div class="fs-6 text-end fw-bold">
                                            <?php 
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <table class="table table-striped table-hover table-bordered" id="inventory">
                            ...
                            <thead>
                                <tr>
                                    <th class="py-0 px-1">Категории</th>
                                    <th class="py-0 px-1">Код товара</th>
                                    <th class="py-0 px-1">Имя товара</th>
                                ...
                                ?>
                                    <tr class="<?php echo $qty < 50? "bg-danger bg-opacity-25":'' ?>">
                                        ...
                                        <td class="td py-0 px-1 text-end">
                                            ...
                                            <?php echo $qty < $row['alert_restock']? "<a href='javascript:void(0)' class='restock me-1' data-pid = '".$row['product_id']."' data-name = '".$row['product_code'].' - '.$row['name']."'> Добавить акцию</a>":'' ?>
                                            <?php endif; ?>
                                            <?php echo $qty ?></td>
                                    </tr>
                                <?php endwhile; ?>
