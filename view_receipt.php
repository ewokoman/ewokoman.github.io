    ...
    <div id="outprint_receipt">
        ...
        <table class="table table-striped">
            ...
            <tr class="bg-dark bg-opacity-75 text-light">
                <th class="py-0 px-1">Кол-во</th>
                <th class="py-0 px-1">Товар</th>
...
<script>
    $(function(){
        ...
        $('#delete_data').click(function(){
            _conf("Вы уверены что хотите удалить <b>"+<?php echo $receipt_no ?>+"</b>?",'delete_data',['<?php echo $transaction_id ?>'])
        })
    })
