        ...
        <div class="w-100 h-100 d-flex flex-column">
            <div class="row">
                ...
                <div class="col-4 d-flex justify-content-end">
                    <button class="btn btn-sm btn-primary rounded-0 " id="transaction-save-btn" type="button">Сохранить продажу</button>
                </div>
            ...
            <form action="" class="h-100" id="transaction-form">
                <div class="w-100 h-100 mx-0 row row-cols-2 bg-dark">
                    <div class="col-8 h-100 pb-2 d-flex flex-column">
                        <div>
                            <h3 class="text-light">Пожалуйста, выберите продукт ниже</h3>
                        </div>
                        <div class="flex-grow-1 d-flex flex-column bg-light bg-opacity-50">
                            <div class="form-group py-2 d-flex border-bottom">
                                <label for="search" class="col-auto px-2 fw-bolder text-light">Поиск</label>
                            ...
                            <div>
                                <table class="table table-hover table-striped bg-light mb-0">
                                    ...
                                    <thead>
                                        <tr>
                                            <th class="py-0 px-1">Категория</th>
                                            <th class="py-0 px-1">Код продукта</th>
                                            <th class="py-0 px-1">Имя продукта</th>
                                            <th class="py-0 px-1">Цена</th>
                                            <th class="py-0 px-1">Доступное количество</th>
                                        </tr>
                                    </thead>
                                </table>
                            </div>
                        ...
                        <div class="h-100 d-flex flex-column">
                            <div class="w-100 flex-grow-1">
                                <div class="h-100 d-flex w-100 flex-column">
                                    <div class="d-flex">
                                    <div class="fs-5 fw-bolder text-light flex-grow-1">Предметы</div>
                                    <div class="col-auto">
                                    ...
                                    <div>
                                        <table class="table table-hover table-bordered table-striped bg-light m-0">
                                            ...
                                            <thead>
                                                <th class="py-0 px-1 text-center">Кол-во</th>
                                                <th class="py-0 px-1 text-center">Товар</th>
                                                <th class="py-0 px-1 text-center">Итог</th>
                                            </thead>
                                        </table>
                                    </div>
                                    <div class="flex-grow-1">
                                    ...
                                    <div class="pt-2">
                                        <div class="w-100 mx-0 d-flex pb-1">
                                            <div class="col-4 pe-2 fs-6 fw-bolder text-light">Под-итог</div>
                                        ...
                                        <div class="w-100 mx-0 d-flex pb-1 align-items-center">
                                            <div class="col-4 pe-2 fs-6 fw-bolder text-light">Налог (13%)<small>
											Включительно</small></div>
                                            <div class="flex-grow-1 bg-light fs-6 fw-bolder text-end px-2" id="tax">0.00</div>
                                        </div>
                                        <div class="w-100 mx-0 d-flex pb-1">
                                            <div class="col-4 pe-2 fs-6 fw-bolder text-light">Итог</div>
