...
<div class="card rounded-0 shadow">
    <div class="card-header d-flex justify-content-between">
        <h3 class="card-title">Отчет о продажах</h3>
    </div>
    <div class="card-body">
        <h5>Фильтр</h5>
        <div class="row align-items-end">
            <div class="form-group col-md-2">
                <label for="date_from" class="control-label">Дата от</label>
                <input type="date" name="date_from" id="date_from" value="<?php echo $dfrom ?>" class="form-control rounded-0">
            </div>
            <div class="form-group col-md-2">
                <label for="date_to" class="control-label">Дата до</label>
                <input type="date" name="date_to" id="date_to" value="<?php echo $dto ?>" class="form-control rounded-0">
            </div>
            <div class="form-group col-md-4 d-flex">
                <div class="col-auto">
                    <button class="btn btn-primary rounded-0" id="filter" type="button"><i class="fa fa-filter"></i> Фильтр</button>
                    <button class="btn btn-success rounded-0" id="print" type="button"><i class="fa fa-print"></i> Печать</button>
                </div>
            </div>
        </div>
        <hr>
        ...
        <table class="table table-hover table-striped table-bordered">
            ...
            <thead>
                <tr>
                    ...
                    <th class="text-center p-0">Дата</th>
                    <th class="text-center p-0">Чек номер</th>
                    <th class="text-center p-0">Предметы</th>
                    <th class="text-center p-0">Итог</th>
                    <th class="text-center p-0">Обработано</th>
                </tr>
            </thead>
            <tbody>
                <?php 
                ...
                <?php if($qry->num_rows <=0): ?>
                    <th colspan="6"><center>Нет продаж на выбранную дату.</center></th>
                <?php endif; ?>
